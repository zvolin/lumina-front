...
*/
export function run_worker(queued_events: (MessageEvent)[], listen_port?: MessagePort): Promise<void>;
/**
...
export interface InitOutput {
  ...
  readonly run_worker: (a: number, b: number, c: number) => number;
  ...
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5e69eb856aafda6c: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h87e175b2d081a0e5: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hba65cc6435e779f6: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0cf2d74243df27ad: (a: number, b: number, c: number) => void;
